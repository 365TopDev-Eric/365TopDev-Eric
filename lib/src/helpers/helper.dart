...
//        },
                ...
                style: style == null
                    ? Theme.of(context).textTheme.subtitle1.merge(
                          TextStyle(
                              ...
                              fontSize: Theme.of(context).textTheme.subtitle1.fontSize - 6),
                        )
                    : style.merge(
  ...
  static void launchWhatsApp() async {
    var phone = '+55065996253743';
    var url;
    if (Platform.isAndroid) {
      // add the [https]
      url = "https://wa.me/message/CZGYP5QDFGZNJ1"; //line
    } else {
      // add the [https]
      url = "https://api.whatsapp.com/send?phone=$phone"; //line
    }
