...
import 'package:markets_owner/src/elements/menu_icon.dart';
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Helper.getPrice(_con.order.payment.price, context,
                            style: Theme.of(context).textTheme.headline6)
                      ],
                    ),
                            ...
                            OutlineButton(
                              onPressed: () {
                                Navigator.of(context).pushNamed('/OrderEdit',
                                    arguments: RouteArgument(id: _con.order.id));
                              },
                                    ...
                                    showDialog(
                                      ...
                                      builder: (BuildContext context) {
                                        ...
                                        return AlertDialog(
                                          ...
                                          content: Text(
                                              S.of(context).areYouSureYouWantToCancelThisOrderOf),
                                          contentPadding:
                              ...
                              Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    S.of(context).items +
                                            ':' +
                                            _con.order.productOrders?.length?.toString() ??
                                        0,
                                    style: Theme.of(context).textTheme.caption,
                                  ),
                                ],
                      ...
                      Tab(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(50),
                              border: Border.all(
                                  color: Theme.of(context).accentColor.withOpacity(0.2), width: 1)),
                          child: Align(
                                  ...
                                  onPressed: () {
                                    ...
                                    Navigator.of(context).pushNamed('/Chat',
                                        arguments: RouteArgument(
                                            param: new Conversation(_users, name: _market.name)));
                                  },
                                  //onPressed: () {
